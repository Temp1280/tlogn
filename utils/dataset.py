...
class tKGDataset(Dataset):  # dataset
    def __init__(self, data_dir, data_type='train', logic=False, logic_ratio=0.5):  # train valid test
        ...
        self.tKG = build_graph(self.n_ent, self.train_facts)  # 
        ...
        self.h_r_dic_all = self.get_h_r_dic_all()  # 

        self.h_r_ts_dic, self.h_r_ts_index_dic = self.get_h_r_ts_dic()  # 
        ...
        if self.logic:
            ...
            train_facts = train_facts[fact_times >= train_time]  # 
